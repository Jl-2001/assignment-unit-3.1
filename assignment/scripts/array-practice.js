...
let favoriteFoods = ['tacos', 'pizza','fries','wings']
console.log(`these foods : ${favoriteFoods} are my favorite!`)
...
console.log(`I added a dessert to the list of fav foods: ${favoriteFoods}`)
